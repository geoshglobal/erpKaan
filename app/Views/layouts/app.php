...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        header.topbar .brand { order:1; margin-right:auto; font-weight:700; letter-spacing:.5px; color:#fff; text-decoration:none; font-size:1.05rem; }
        ...
        .hamburger:hover { color:#fff; background:#1e293b; }
        ...
        nav.mainnav a:hover { color:#fff; background:#1e293b; }
        ...
        .user-menu .menu { position:absolute; right:0; top:calc(100% + .4rem); background:#fff; color:#0f172a; border:1px solid var(--line); border-radius:8px; min-width:210px; box-shadow:0 8px 24px rgba(0,0,0,.18); z-index:30; overflow:hidden; }
        .user-menu .menu a { display:block; padding:.7rem .9rem; color:#0f172a; font-size:.9rem; }
        ...
        .tenant-select select { background:#1e293b; color:#fff; border:1px solid #334155; border-radius:8px; padding:.35rem .5rem; font-size:.85rem; max-width:44vw; }
        ...
        .stepper button { border:none; background:#f1f5f9; color:#0f172a; width:46px; font-size:1.3rem; line-height:1; cursor:pointer; }
        ...
        .notif-banner a.nb-cta { background:#0d9488; color:#fff; text-decoration:none; padding:.4rem .8rem; border-radius:8px; font-weight:600; }
